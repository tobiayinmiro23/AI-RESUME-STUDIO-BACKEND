...
6. the AI response is much closer to the schema but not 100% complete, it ends after education section and that array is not closed, this would throw an error